 ...
 * - Within deletions, order by type, desc, so as to delete in the reverse order from the schema set
 * - Within updates, order by type, as, so as to create in the order from the schema set
